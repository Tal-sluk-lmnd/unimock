...
import mayaImage from '../../Assets/maya2.png'
...
// Avatar Component based on Figma design
interface AvatarBubbleProps {
  onTypingComplete?: () => void
}

export default function AvatarBubble({ onTypingComplete }: AvatarBubbleProps) {
  const message = "Hey Keren, I'm Maya. I'll get you insured in no time. What would you like?"
